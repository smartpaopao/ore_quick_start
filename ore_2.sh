...
echo "$user_input" > /home/ubuntu/.config/solana/id2.json
...
while true
do 
   ./ore --rpc https://solana-mainnet.phantom.app/YBPpkkN4g91xDiAnTE9r0RcMkjg0sKUIWvAfoFVJ --keypair ~/.config/solana/id2.json --priority-fee 100000 mine --threads 30
done
